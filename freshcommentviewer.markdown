...
## 最新版
[v0.1.8](https://github.com/ryu-s/AbemaFreshCommentViewer/releases/download/v0.1.8/AbemaFreshCommentViewer_v0.1.8.zip)（2016/10/06）パフォーマンス向上。配信者のコメントにアイコンを付けてみた。不具合が起こる可能性があったため対応  
